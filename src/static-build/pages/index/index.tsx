...
const Index: FunctionalComponent<Props> = () => (
  <html lang="en">
    <head>
      ...
      <meta
        name="description"
        content="PicZip is the ultimate image optimizer that allows you to compress and compare images with different codecs in your browser."
      />
      <meta name="twitter:card" content="summary" />
      <meta name="twitter:site" content="@PicZip" />
      <meta property="og:title" content="PicZip" />
